  ...
  const reasons = [
    {
      ...
      description: 'RevLabs is a curated team of product and tech experts, featuring top talent from India\'s leading unicorns like Flipkart, Swiggy, and Ola, and alumni from IITs, NITs, and IIMs—all with a proven record of driving business growth.',
      image: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80'
    },
    {
      id: 'drive-growth',
      title: 'Drive growth, without growing costs',
      description: 'We follow iterative development process and expertise in open source platform. Thus we help you maximise your ROI with quicker go-to-market, but without growing your tech cost.',
      image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80'
    },
    {
      id: 'fast-delivery',
      title: 'Fast kickoff, faster deliver',
      description: 'We in-house team allow us to get the project kickoff within 3-5 days. Years of experience further enable us to build projects quickly and deliver results fast.',
          ...
          <div>
            ...
            <div className="space-y-8">
              {reasons.map((reason, index) => (
                ...
                >
                  {/* Timeline dot */}
                  <div className={`absolute left-0 top-2 w-4 h-4 rounded-full transition-all duration-300 ${
